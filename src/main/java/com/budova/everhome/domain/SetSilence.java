...
public class SetSilence {
    ...
    public SetSilence(Long id, Parameter param, LocalDateTime time, Float value) {
        this.id = id;
        this.param = param;
        this.time = time;
        this.value = value;
    ...
    public SetSilence(Parameter param, LocalDateTime time, Float value) {
        this.param = param;
        this.time = time;
        this.value = value;
    }
    ...
    public static float inBorder(SetSilence value){
