...
public class SetWaterFloor {
    ...
    public SetWaterFloor(Long id, Parameter param, LocalDateTime time, Float value) {
        this.id = id;
        this.param = param;
        this.time = time;
        this.value = value;
    ...
    public SetWaterFloor(Parameter param, LocalDateTime time, Float value) {
        this.param = param;
        this.time = time;
        this.value = value;
    }
    ...
    public static float inBorder(SetWaterFloor value){
