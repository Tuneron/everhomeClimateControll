...
public class SetNight {
    ...
    public SetNight(Long id, Parameter param, LocalDateTime time, Float value) {
        this.id = id;
        this.param = param;
        this.time = time;
        this.value = value;
    ...
    public SetNight(Parameter param, LocalDateTime time, Float value) {
        this.param = param;
        this.time = time;
        this.value = value;
    }
    ...
    public static float inBorder(SetNight value){
