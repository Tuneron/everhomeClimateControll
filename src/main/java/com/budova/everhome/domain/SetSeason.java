...
public class SetSeason {
    ...
    public SetSeason(Long id, Parameter param, LocalDateTime time, Float value) {
        this.id = id;
        this.param = param;
        this.time = time;
        this.value = value;
    ...
    public SetSeason(Parameter param, LocalDateTime time, Float value) {
        this.param = param;
        this.time = time;
        this.value = value;
    }
    ...
    public static float inBorder(SetSeason value){
