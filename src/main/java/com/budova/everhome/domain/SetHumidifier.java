...
public class SetHumidifier  {
    ...
    public SetHumidifier() {
    }

    public SetHumidifier(Long id, Parameter param, LocalDateTime time, Float value) {
        this.id = id;
        this.param = param;
        this.time = time;
        this.value = value;
    ...
    public SetHumidifier(Parameter param, LocalDateTime time, Float value) {
        this.param = param;
        this.time = time;
        this.value = value;
    }
    ...
    public static float inBorder(SetHumidifier value){
